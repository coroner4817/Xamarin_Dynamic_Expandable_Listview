...
namespace Com.Nhaarman.Listviewanimations.Appearance.Simple {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.nhaarman.listviewanimations.appearance.simple']/class[@name='ScaleInAnimationAdapter']"
	[global::Android.Runtime.Register ("com/nhaarman/listviewanimations/appearance/simple/ScaleInAnimationAdapter", DoNotGenerateAcw=true)]
	public partial class ScaleInAnimationAdapter : global::Com.Nhaarman.Listviewanimations.Appearance.AnimationAdapter {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/nhaarman/listviewanimations/appearance/simple/ScaleInAnimationAdapter", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.appearance.simple']/class[@name='ScaleInAnimationAdapter']/constructor[@name='ScaleInAnimationAdapter' and count(parameter)=1 and parameter[1][@type='android.widget.BaseAdapter']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;)V", "")]
		public unsafe ScaleInAnimationAdapter (global::Android.Widget.BaseAdapter p0)
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nhaarman.listviewanimations.appearance.simple']/class[@name='ScaleInAnimationAdapter']/constructor[@name='ScaleInAnimationAdapter' and count(parameter)=2 and parameter[1][@type='android.widget.BaseAdapter'] and parameter[2][@type='float']]"
		[Register (".ctor", "(Landroid/widget/BaseAdapter;F)V", "")]
		public unsafe ScaleInAnimationAdapter (global::Android.Widget.BaseAdapter p0, float p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (GetType () != typeof (ScaleInAnimationAdapter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/widget/BaseAdapter;F)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/widget/BaseAdapter;F)V", __args);
					return;
				}
				...
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_widget_BaseAdapter_F, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_widget_BaseAdapter_F, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Nhaarman.Listviewanimations.Appearance.Simple.ScaleInAnimationAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Nhaarman.Listviewanimations.Appearance.Simple.ScaleInAnimationAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nhaarman.listviewanimations.appearance.simple']/class[@name='ScaleInAnimationAdapter']/method[@name='getAnimators' and count(parameter)=2 and parameter[1][@type='android.view.ViewGroup'] and parameter[2][@type='android.view.View']]"
